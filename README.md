...
1. `-n` argument is used for picking how many players we want to play with. We can choose from 2 to 4. If we decide to skip `-n` argument the game will start with 2 players.
